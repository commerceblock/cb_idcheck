...
class idcheck:
    ...
    def parse_args(self, argv=None):
        ...
        parser.add_argument('--token_file', required=False, type=str, help="Onfido API token. Default=$IDCHECK_API_TOKEN_FILE", default=self.token_file)
        ...
        self.idcheck_token_file=args.token_file
        self.id_api=cb_onfido.cb_onfido(token_file=self.idcheck_token_file)
    ...
    def __init__(self, token_file=os.environ.get('IDCHECK_API_TOKEN_FILE', None), master=None):
