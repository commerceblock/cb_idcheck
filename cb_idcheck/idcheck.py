...
class idcheck:
    def parse_args(self, argv=None):
        ...
        parser.add_argument('--token', required=False, type=str, help="Onfido API token. Default=$IDCHECK_API_TOKEN", default=os.environ.get('IDCHECK_API_TOKEN', None))
        ...
        self.id_api=cb_onfido.cb_onfido(token=args.token)
